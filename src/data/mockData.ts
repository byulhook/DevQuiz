export const data = {
  ...
  react: [
    ...
    {
      id: '28',
      question: 'React에서 props의 기본값을 설정하는 방법은 무엇입니까?',
      options: ['defaultProps', 'initialProps', 'useDefault', 'useProps'],
      answer: 'defaultProps',
    },
    {
      id: '29',
      question: 'React에서 상태(state)를 업데이트할 때, 비동기적으로 작동하는 함수는 무엇입니까?',
      options: ['setState', 'forceUpdate', 'getDerivedStateFromProps', 'useReducer'],
      answer: 'setState',
    },
    {
      id: '30',
      question: 'React에서 비동기 작업을 처리하기 위해 주로 사용하는 Hook은 무엇입니까?',
  ...
  typescript: [
    ...
    {
      id: '26',
      question: 'TypeScript에서 `typeof` 연산자는 무엇을 확인합니까?',
      options: ['변수의 타입', '변수의 값', '변수의 범위', '변수의 참조'],
      answer: '변수의 타입',
    },
    {
      id: '27',
      question: 'TypeScript에서 `interface`와 `type`의 차이점은 무엇입니까?',
      options: [
        '`interface`는 객체의 형태를 설명하고, `type`은 다양한 타입을 정의할 수 있습니다.',
        '`interface`는 상속이 불가능하고, `type`은 가능합니다.',
        '`type`은 함수만 정의할 수 있고, `interface`는 객체만 정의할 수 있습니다.',
        '`interface`는 제네릭을 사용할 수 없지만, `type`은 가능합니다.',
      ],
      answer: '`interface`는 객체의 형태를 설명하고, `type`은 다양한 타입을 정의할 수 있습니다.',
    },
    {
      id: '28',
      question: 'TypeScript에서 `any` 타입을 사용할 때의 단점은 무엇입니까?',
      options: [
        '타입 안전성이 보장되지 않습니다.',
        '비동기 처리가 불가능합니다.',
        'DOM 조작이 불가능합니다.',
      ...
      answer: '타입 안전성이 보장되지 않습니다.',
    },
    {
      id: '29',
      question: 'TypeScript에서 `interface`와 `class`의 공통점은 무엇입니까?',
      options: [
        '둘 다 객체의 구조를 정의할 수 있습니다.',
        '둘 다 상속을 지원하지 않습니다.',
        '둘 다 변수를 선언할 수 있습니다.',
        '둘 다 함수의 반환값을 정의할 수 있습니다.',
      ],
      answer: '둘 다 객체의 구조를 정의할 수 있습니다.',
    },
    {
      id: '30',
      question: 'TypeScript에서 객체 타입을 정의하는 가장 기본적인 방법은?',
  ...
  nextjs: [
    ...
    },
    {
      ...
      options: ['<Image>', '<img>', '<picture>', '<source>'],
      answer: '<Image>',
    },
    {
      id: '27',
      question: 'Next.js의 자동 정적 최적화(Automatic Static Optimization)는 언제 발생합니까?',
      options: [
        'getStaticProps 또는 getServerSideProps가 없는 페이지일 때',
        'getStaticProps 또는 getServerSideProps가 있는 페이지일 때',
        '페이지에 fetch 요청이 있을 때',
        '페이지에 스타일이 없을 때',
      ],
      answer: 'getStaticProps 또는 getServerSideProps가 없는 페이지일 때',
    },
    {
      id: '28',
      question: 'Next.js에서 정적 경로를 생성하기 위해 사용하는 함수는 무엇입니까?',
      options: ['getStaticPaths', 'getStaticProps', 'getServerSideProps', 'useEffect'],
      answer: 'getStaticPaths',
    },
    {
      id: '29',
      question: 'Next.js에서 자동 정적 최적화를 사용할 수 없는 경우는 무엇입니까?',
      options: [
        'getServerSideProps가 있는 페이지',
        'getStaticProps가 있는 페이지',
        '정적 자원이 없을 때',
        'API 라우트를 사용할 때',
      ],
      answer: 'getServerSideProps가 있는 페이지',
    },
    {
      id: '30',
      question: 'Next.js에서 라우트에 대한 글로벌 미들웨어를 설정하는 방법은 무엇입니까?',
      options: [
        'Middleware 파일을 사용하여 설정',
        'getStaticProps에서 설정',
        'Head 컴포넌트에서 설정',
        'useState에서 설정',
      ],
      answer: 'Middleware 파일을 사용하여 설정',
    },
  ],
};
